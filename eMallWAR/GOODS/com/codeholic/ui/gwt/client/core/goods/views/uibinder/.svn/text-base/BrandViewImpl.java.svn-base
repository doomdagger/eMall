...
public class BrandViewImpl extends Composite implements BrandView {

	private static BrandViewImplUiBinder uiBinder = GWT
			.create(BrandViewImplUiBinder.class);

	private BrandPresenter presenter;

	interface BrandViewImplUiBinder extends UiBinder<Widget, BrandViewImpl> {
	}

	public BrandViewImpl() {
	...
	@Override
	public void setPresenter(BrandPresenter presenter) {
