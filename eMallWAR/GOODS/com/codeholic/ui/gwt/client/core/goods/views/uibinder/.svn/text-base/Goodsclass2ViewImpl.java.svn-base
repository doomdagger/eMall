...
public class Goodsclass2ViewImpl extends Composite implements Goodsclass2View{

	private static Goodsclass2ViewImplUiBinder uiBinder = GWT
			.create(Goodsclass2ViewImplUiBinder.class);

	private Goodsclass2Presenter presenter;
	
	interface Goodsclass2ViewImplUiBinder extends
			UiBinder<Widget, Goodsclass2ViewImpl> {
	}

	@UiField
	SimplePanel parentPanel;
	
	public Goodsclass2ViewImpl() {
		initWidget(uiBinder.createAndBindUi(this));
	}

	@Override
	public void setPresenter(Goodsclass2Presenter presenter) {
	...
	public Widget createToolBar() {
		...
		TextButton singleAddButton = new TextButton("添加商品");
		singleAddButton.setIcon(Resources.IMAGES.add());

		TextButton batchAddButton = new TextButton("批量添加商品");
